...
public class TheKeyLdap {
    ...
    private static List<String> googleGroups =
            Arrays.asList(
                    ...
                    "CN=GAiN,CN=Cru,CN=GoogleApps,CN=Groups,CN=idm,DC=cru,DC=org",
                    "CN=Policies,CN=GAiN,CN=Cru,CN=GoogleApps,CN=Groups,CN=idm,DC=cru,DC=org",
                    "CN=TwoFactor,CN=Policies,CN=GAiN,CN=Cru,CN=GoogleApps,CN=Groups,CN=idm,DC=cru,DC=org",
                    "CN=Mobile,CN=Policies,CN=GAiN,CN=Cru,CN=GoogleApps,CN=Groups,CN=idm,DC=cru,DC=org",
                    "CN=Forward,CN=Policies,CN=GAiN,CN=Cru,CN=GoogleApps,CN=Groups,CN=idm,DC=cru,DC=org",
